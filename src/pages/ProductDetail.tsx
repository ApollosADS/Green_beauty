...
const ProductDetail = () => {
  ...
  const product = {
    ...
    description:
      'Notre savon artisanal au beurre de karité est un véritable trésor de la cosmétique africaine traditionnelle. Fabriqué à la main avec amour, ce savon combine les bienfaits nourrissants du beurre de karité pur avec des huiles essentielles naturelles pour offrir à votre peau un soin exceptionnel.',
    benefits: [
    ...
    usage:
      "Faire mousser entre les mains humides et appliquer sur peau mouillée. Masser délicatement puis rincer à l'eau tiède. Utilisation quotidienne recommandée.",
    conservation:
      "Conserver dans un endroit sec, à l'abri de la lumière directe. Durée de conservation : 12 mois.",
    origin:
      "Fabriqué artisanalement en Côte d'Ivoire avec des ingrédients locaux de première qualité.",
  };
  ...
  const relatedProducts = [
    ...
    },
    {
      ...
      price: 12000,
      image:
        'https://images.pexels.com/photos/7755515/pexels-photo-7755515.jpeg?auto=compress&cs=tinysrgb&w=400',
      rating: 4.7,
    },
    {
      id: 4,
    ...
    <div className='min-h-screen bg-gray-50'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
        ...
        <nav className='flex items-center space-x-2 text-sm text-gray-600 mb-8'>
          ...
          <span>/</span>
          <a href='/boutique' className='hover:text-purple-600'>
            Boutique
          </a>
          <span>/</span>
          <a href='/boutique/savons' className='hover:text-purple-600'>
            Savons
          </a>
          <span>/</span>
                  ...
                  >
                    <div className='text-center'>
                      ...
                      <div className='text-sm text-gray-600'>
                        {sizeOption.price.toLocaleString()} FCFA
                      </div>
                    </div>
                  </button>
                ))}
