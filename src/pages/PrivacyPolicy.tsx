      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            Green Beauty s'engage à protéger la confidentialité et la sécurité de vos informations personnelles. 
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            Cette politique est effective à partir du 1er janvier 2024.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mt-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="font-semibold text-gray-900 mb-3">Droit d'accès</h3>
              <p className="text-gray-600 text-sm">
                Vous pouvez demander une copie des données personnelles que nous détenons sur vous.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-3">Droit de rectification</h3>
              <p className="text-gray-600 text-sm">
                Vous pouvez demander la correction de données inexactes ou incomplètes.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-3">Droit à l'effacement</h3>
              <p className="text-gray-600 text-sm">
                Vous pouvez demander la suppression de vos données dans certaines circonstances.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-3">Droit d'opposition</h3>
              <p className="text-gray-600 text-sm">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mt-8">
          ...
          <ul className="space-y-2 mb-6">
            <li className="flex items-start space-x-3">
              ...
              <span className="text-gray-600">Mémoriser vos préférences et votre panier</span>
            </li>
            <li className="flex items-start space-x-3">
              <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
              <span className="text-gray-600">Analyser le trafic et l'utilisation du site</span>
            </li>
            <li className="flex items-start space-x-3">
              <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
              <span className="text-gray-600">Personnaliser le contenu et les publicités</span>
            </li>
          </ul>
          <p className="text-gray-600 text-sm">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mt-8">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
              ...
              <span className="text-purple-600 font-semibold">Jusqu'à suppression du compte</span>
            </div>
            <div className="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
              <span className="font-medium text-gray-900">Historique des commandes</span>
              <span className="text-purple-600 font-semibold">10 ans (obligations comptables)</span>
            </div>
            <div className="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
              <span className="font-medium text-gray-900">Données de navigation</span>
              <span className="text-purple-600 font-semibold">13 mois maximum</span>
            </div>
            <div className="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
              <span className="font-medium text-gray-900">Newsletter</span>
              <span className="text-purple-600 font-semibold">Jusqu'à désinscription</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6 mt-8">
          <h3 className="font-semibold text-amber-800 mb-2">Mise à jour de cette politique</h3>
