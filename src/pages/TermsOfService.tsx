      ...
      <section className='bg-gradient-to-r from-purple-600 to-green-600 text-white py-16'>
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <p className='text-xl opacity-90'>
            Conditions régissant l'utilisation de notre site et l'achat de nos
            produits
          </p>
        </div>
      </section>
      ...
      <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
          ...
          <div className='space-y-4'>
            <div>
              ...
              <p className='text-gray-600 text-sm leading-relaxed'>
                Green Beauty garantit que tous ses produits sont conformes aux
                descriptions et fabriqués selon les standards de qualité les
                plus élevés. En cas de défaut de fabrication, le produit sera
            ...
            <div>
              ...
              <p className='text-gray-600 text-sm leading-relaxed'>
                Green Beauty ne saurait être tenue responsable des dommages
                indirects ou consécutifs résultant de l'utilisation de ses
                produits. Il est recommandé de faire un test de tolérance avant
            ...
            <div>
              ...
              <p className='text-gray-600 text-sm leading-relaxed'>
                Green Beauty ne pourra être tenue responsable de l'inexécution
                de ses obligations en cas de force majeure ou de circonstances
        ...
        <div className='bg-white rounded-2xl shadow-lg p-8 mt-8'>
          ...
          <p className='text-gray-600 leading-relaxed mb-4'>
            Les informations recueillies lors de votre commande sont nécessaires
            au traitement de celle-ci. Elles sont destinées à Green Beauty et ne
          ...
          <p className='text-gray-600 leading-relaxed'>
            ...
            exercer ce droit, contactez-nous à contact@greenbeauty.com.
          </p>
          <div className='mt-4'>
            <a
        ...
        <div className='bg-white rounded-2xl shadow-lg p-8 mt-8'>
          ...
          <p className='text-gray-600 leading-relaxed mb-4'>
            Tous les éléments du site Green Beauty (textes, images, logos,
            vidéos) sont protégés par le droit d'auteur et appartiennent à Green
            Beauty ou à ses partenaires.
          </p>
          <p className='text-gray-600 leading-relaxed'>
            Toute reproduction, représentation, modification, publication ou
            transmission de ces éléments est strictement interdite sans
        ...
        <div className='bg-white rounded-2xl shadow-lg p-8 mt-8'>
          ...
          <p className='text-gray-600 leading-relaxed'>
            À défaut d'accord amiable, tout litige sera porté devant les
            tribunaux compétents de Cotonou, Bénin.
          </p>
        </div>
        ...
        <div className='bg-gray-100 rounded-2xl p-6 mt-8 text-center'>
          ...
          <p className='text-gray-500 text-xs mt-2'>
            Green Beauty se réserve le droit de modifier ces conditions à tout
