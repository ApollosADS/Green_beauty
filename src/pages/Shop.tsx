  ...
  const products = [
    {
      ...
      badge: 'Bestseller',
      description:
        'Savon artisanal enrichi au beurre de karité pur, nourrissant et hydratant pour tous types de peaux.',
    },
    {
      id: 2,
      ...
      badge: 'Nouveau',
      description:
        'Huile précieuse de baobab, riche en vitamines A, D, E et F. Anti-âge naturel exceptionnel.',
    },
    {
      id: 3,
      ...
      badge: 'Bio',
      description:
        "Masque purifiant à l'argile verte du Sahel, idéal pour les peaux mixtes à grasses.",
    },
    {
      id: 4,
      ...
      category: 'body',
      description:
        'Beurre de cacao pur non raffiné, parfait pour nourrir et protéger la peau.',
    },
    {
      id: 5,
      ...
      category: 'hair',
      description:
        'Shampoing naturel aux feuilles de moringa, fortifiant et purifiant pour tous types de cheveux.',
    },
    {
      id: 6,
      ...
      category: 'body',
      description:
        'Gommage exfoliant au café arabica et huile de coco, pour une peau douce et lisse.',
    },
  ];
      ...
      <div className='bg-gradient-to-r from-purple-600 to-green-600 text-white py-16'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <p className='text-xl opacity-90 max-w-2xl mx-auto'>
            Découvrez notre collection complète de cosmétiques artisanaux
            africains naturels
          </p>
        </div>
      </div>
