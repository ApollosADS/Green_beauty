  ...
  const shippingZones = [
    {
      ...
      description:
        'Livraison rapide dans toute la ville de Cotonou et ses environs immédiats.',
    },
    {
      zone: 'Porto-Novo',
      icon: '🏛️',
    ...
    },
    {
      ...
      freeFrom: '15.000 FCFA',
      description:
        'Livraison dans toutes les autres villes du Bénin selon la distance.',
    },
  ];
  ...
  const deliverySteps = [
    {
      ...
      description:
        'Vous recevez un SMS de confirmation avec le numéro de suivi',
      icon: Package,
      time: 'Immédiat',
    },
    {
      ...
      <section className='bg-gradient-to-r from-purple-600 to-green-600 text-white py-16'>
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <p className='text-xl opacity-90'>
            Tout ce que vous devez savoir sur nos services de livraison et notre
      ...
      <div className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
        ...
        <div className='mb-16'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-600'>
              Nous livrons dans tout le Bénin avec des délais adaptés à chaque
              région
            </p>
          </div>
            ...
            <div className='space-y-4'>
              ...
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Une personne doit être présente pour réceptionner le colis
                  </p>
                </div>
              </div>
              <div className='flex items-start space-x-3'>
              ...
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Second passage facturé 1.000 FCFA
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className='space-y-4'>
              ...
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    À votre charge, sauf défaut du produit
                  </p>
                </div>
              </div>
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Sous 7 jours ouvrés après réception du retour
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className='grid md:grid-cols-2 gap-6'>
            <div>
              ...
              <p className='text-gray-600 text-sm mb-4'>
                Oui, tant que votre commande n'a pas été expédiée.
                Contactez-nous rapidement au 69 01 24 48.
              </p>
            </div>
            <div>
              <h4 className='font-semibold text-gray-900 mb-2'>
              ...
              <p className='text-gray-600 text-sm mb-4'>
                Refusez la livraison et contactez-nous immédiatement. Nous
                organiserons un remplacement gratuit.
              </p>
            </div>
            <div>
              <h4 className='font-semibold text-gray-900 mb-2'>
            ...
            <div>
              ...
              <p className='text-gray-600 text-sm mb-4'>
                Vous recevrez un SMS avec le numéro de suivi. Vous pouvez aussi
                nous appeler pour un suivi personnalisé.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='bg-gradient-to-r from-purple-600 to-green-600 rounded-2xl p-8 text-white text-center'>
          ...
          <p className='text-lg opacity-90 mb-6'>
            Notre équipe est disponible pour vous renseigner sur nos services de
            livraison
          </p>
