  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment:
        "Les produits Green Beauty ont transformé ma routine beauté. Ma peau n'a jamais été aussi douce et éclatante !",
      image:
    ...
    },
    {
      ...
      rating: 5,
      comment:
        "L'huile de baobab est magique ! Mes cheveux sont plus forts et brillants. Je recommande vivement.",
      image:
    ...
    },
    {
      ...
      rating: 5,
      comment:
        "Enfin des produits qui respectent ma peau ! L'argile verte purifie en douceur sans agresser.",
      image:
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-lg text-gray-600 max-w-2xl mx-auto'>
            Découvrez les témoignages authentiques de femmes qui ont adopté nos
            produits dans leur routine beauté quotidienne.
          </p>
        </div>
