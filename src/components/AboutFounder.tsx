        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl p-6 shadow-xl max-w-xs">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-purple-600 font-semibold">- Fondatrice</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Une passion pour la <span className="text-purple-600">beauté authentique</span>
            </h2>

            <p className="text-lg text-gray-600 mb-6">
              Née d'une passion profonde pour les traditions cosmétiques africaines, 
              Green Beauty a été créée pour partager les secrets de beauté transmis 
              de génération en génération.
            </p>

            <p className="text-gray-600 mb-8">
              Notre fondatrice, inspirée par sa grand-mère herboriste, a consacré des années 
              à étudier les propriétés des plantes africaines pour créer des formules 
              uniques qui respectent votre peau et l'environnement.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">100% Naturel</h4>
                  <p className="text-sm text-gray-600">Ingrédients purs d'Afrique</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Artisanal</h4>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Communauté</h4>
