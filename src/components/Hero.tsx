        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-2xl">
              Découvrez nos cosmétiques artisanaux africains, créés avec amour à partir d'ingrédients naturels 
              pour révéler la beauté authentique de votre peau.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <button className="bg-purple-600 text-white px-8 py-4 rounded-full font-semibold hover:bg-purple-700 transition-all duration-300 transform hover:scale-105 flex items-center justify-center group">
            ...
            <div className="relative z-10">
              ...
              <div className="absolute top-6 left-6 bg-white/90 backdrop-blur-sm rounded-2xl p-4 shadow-lg">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium text-gray-800">Produits frais</span>
                </div>
              </div>
              ...
              <div className="absolute bottom-6 right-6 bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-lg max-w-xs">
                <div className="flex items-center space-x-3">
                  ...
                  />
                  <div>
                    <h4 className="font-semibold text-gray-800 text-sm">Savon au Karité</h4>
                    <p className="text-purple-600 font-bold text-sm">15.000 FCFA</p>
                  </div>
                </div>
              </div>
            </div>
